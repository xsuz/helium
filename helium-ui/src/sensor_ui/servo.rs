                ...
                egui::Window::new("Servo").vscroll(true).show(ctx, |ui| {
                    egui::SidePanel::right("Servo_l_panel").show_inside(ui, |ui| {
                        ...
                        painter.line_segment(
                            [
                                rect.center(),
                                rect.center()
                                    + egui::vec2(servo_data.rudder * r, servo_data.elevator * r),
                            ],
                            stroke_frame,
                        );
                            ...
                            .show(ui, |plot_ui| {
                                if db.servo.data.len() > 100 {
                                    ...
                                    let point_servo: egui_plot::PlotPoints = db.servo.data
                                        ...
                                        .iter()
                                        .map(|(data, time)| {
                                            [*time as f64, data.position_rudder as f64]
                                        })
                                        .collect();
                                    ...
                                    let point_servo: egui_plot::PlotPoints = db.servo.data
                                        ...
                                        .iter()
                                        .map(|(data, time)| {
                                            [*time as f64, data.position_elevator as f64]
                                        })
                                        .collect();
                                    ...
                                    plot_ui.set_plot_bounds(egui_plot::PlotBounds::from_min_max(
                                        [(db.servo.data.last().unwrap().1 - self.cursor.range) as f64,90.0],
                                        [db.servo.data.last().unwrap().1 as f64, 0.0],
                                    ));
                                }
                            });
                    });
                    ...
                    ui.add(
                        eframe::egui::widgets::ProgressBar::new(
                            servo_data.position_rudder / 40.0 + 0.5,
                        )
                        .text(format!(
                            "pos_rudder:\t{:2.2}deg",
                            servo_data.position_rudder
                        )),
                    );
                    ui.add(
                    ...
                    ui.add(
                        eframe::egui::widgets::ProgressBar::new(
                            servo_data.position_elevator / 40.0 + 0.5,
                        )
                        .text(format!(
                            "pos_elevator:\t{:2.2}deg",
                            servo_data.position_elevator
                        )),
                    );
